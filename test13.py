...
r = Recognizer()
m = sr.Microphone()
input_mic = 'microphone-BWA19HO011'  # Use whatever is your desired input
...
while True:
    ...
    try:
        if words[0] == 'album':
            ...
            play_album(spotify=spotify, device_id=deviceID)
        elif words[0] == 'artist':
            #uri = get_artist_uri(spotify=spotify, name=name)
            play_artist(spotify=spotify, device_id=deviceID)
        elif words[0] == 'play':
